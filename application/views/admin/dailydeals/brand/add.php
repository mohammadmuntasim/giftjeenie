<div class="container minus-margin">
    ...
    <div class="col-sm-12">
      ...
      $attributes = array('class' => 'form-horizontal', 'id' => 'add_brand','enctype'=>"multipart/form-data",'method'=>'post');
                         ...
                         echo form_open('admin/dailydeals/brand/add', $attributes);
            ?>
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="col-sm-12">
                        	  ...
                        	  <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="brand_name" name="brand_name" value="<?php echo set_value('brand_name'); ?>"  required> 
                            </div>
                        </div>
							           <div class="form-group">
