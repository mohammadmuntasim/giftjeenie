	...
	<div class="row">
        <div class="col-sm-12">
            ...
            <?php
                ...
                echo form_open('admin/dailydeals/brand/' . $branddata->brand_id . '/add_item', $attributes);
            ?>
            <div class="col-sm-9">
                <div class="main-content">
                    <div class="col-sm-12">
                        <div class="row">
                            <a href="<?php echo base_url() . 'admin/dailydeals/brand/' . $branddata->brand_id . '/edit';  ?>">< <?php echo $branddata->brand_name ?></a>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-sm-offset-4">
                                <button type="submit" name="submit" class="btn btn-product" style="width: 100%; background-color: #9197a3;">Done</button>
                            </div>
                        </div>
                    </div>
                </div>
